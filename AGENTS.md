# AGENTS.md — Tulip Build Roadmap

This file is the source of truth for building Tulip with Codex. Work phases **in order**.
...
- [ ] Wire `@tulip/ai` to the Anthropic SDK (`FLINT_MODEL=Codex-sonnet-4-6`).
